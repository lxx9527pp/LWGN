...
class GraspDatasetBase(torch.utils.data.Dataset):
    def __init__(self, output_size=300, include_depth=True, include_rgb=False, random_rotate=False,
                 random_zoom=False, input_only=False, include_mask=False):
        """
        ...
        # print(include_depth, include_rgb, include_mask)
        self.grasp_files = []

        if include_depth is False and include_rgb is False and include_mask is False:
    ...
    def __getitem__(self, idx):
        ...
        if self.include_mask:
            mask_img = self.get_mask(idx, rot, zoom_factor)
        ...
        if self.include_depth and self.include_rgb:
            ...
            x = self.numpy_to_torch(mask_img)
